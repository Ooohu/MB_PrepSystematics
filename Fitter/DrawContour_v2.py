...
if __name__=="__main__":
   ...
   #cont = myContour("output/fit_oct19_contour_nuonly.root")
   #cont.Draw("figures/oct19/contNoFake_fit_nuonly_oct19",plotLSND=False)

   cont = myContour(sys.argv[1])
   cont.Draw("figures/oct19/contNunubar/contNoFake_fit_nuNubar_oct19",plotLSND=False)
