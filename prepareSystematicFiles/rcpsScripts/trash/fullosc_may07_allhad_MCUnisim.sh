...
then
   ...
   export INPUTFILES="/scratch/condor-tmp/zarko/data_area/numode/multisim_reweightings/AllHad_Unisim/AllHad_FullOsc_NuePreCuts/${1}/Likelihood_Final_Full_Dirtcut/*.root"
