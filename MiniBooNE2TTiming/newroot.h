...
// Wed Sep 23 13:28:04 2020 by ROOT version 6.12/04
// from TTree MiniBooNE/Created in /scratch/klin/SystematicFiles/numu/TTree_MiniBooNE/may06_om_mul/may06_om_reweighted_mul005.root
// found on file: /scratch/klin/SystematicFiles/numu/TTree_MiniBooNE/may06_om_mul/may06_om_reweighted_mul005.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxTHistory = 395;
   static constexpr Int_t kMaxTHistory_algo_name = 395;
   static constexpr Int_t kMaxTHistory_algo_inst = 395;
   static constexpr Int_t kMaxTHistory_chunk_name = 395;
   static constexpr Int_t kMaxTHistory_ext_name = 395;
   static constexpr Int_t kMaxTHistory_version = 395;
   static constexpr Int_t kMaxTHistory_node = 395;
   static constexpr Int_t kMaxTHistory_database = 395;
   static constexpr Int_t kMaxTHistory_inst_num = 395;
   static constexpr Int_t kMaxTHistory_timestamp = 395;
   static constexpr Int_t kMaxTHistory_rcpid = 395;
   static constexpr Int_t kMaxTHistory_chunkid = 395;
   static constexpr Int_t kMaxTHistory_parents = 395;
   static constexpr Int_t kMaxTHistory_tags = 395;
   ...
   static constexpr Int_t kMaxTnumuCCQElikeChunk = 2;
   static constexpr Int_t kMaxTnumuCCQElikeChunk_chunk_id = 2;
   static constexpr Int_t kMaxTnumuCCQElikeChunk_name = 2;
   ...
   static constexpr Int_t kMaxTBacklightExcessLiteChunk = 9;
   static constexpr Int_t kMaxTBacklightExcessLiteChunk_chunk_id = 9;
   static constexpr Int_t kMaxTBacklightExcessLiteChunk_name = 9;
   ...
   static constexpr Int_t kMaxTTwoTrackChunk = 1;
   static constexpr Int_t kMaxTTwoTrackChunk_chunk_id = 1;
   static constexpr Int_t kMaxTTwoTrackChunk_name = 1;
   static constexpr Int_t kMaxTTwoTrackEndConditionsChunk = 1;
   static constexpr Int_t kMaxTTwoTrackEndConditionsChunk_chunk_id = 1;
   static constexpr Int_t kMaxTTwoTrackEndConditionsChunk_name = 1;
   static constexpr Int_t kMaxTTwoTrackInternalsChunk = 1;
   static constexpr Int_t kMaxTTwoTrackInternalsChunk_chunk_id = 1;
   static constexpr Int_t kMaxTTwoTrackInternalsChunk_name = 1;
   ...
   static constexpr Int_t kMaxTParticleIDChunk = 156;
   static constexpr Int_t kMaxTParticleIDChunk_chunk_id = 156;
   static constexpr Int_t kMaxTParticleIDChunk_name = 156;
...
newroot::newroot(TTree *tree) : fChain(0) 
{
	...
	TString dir_path = "/scratch/klin/SystematicFiles/numu/TTree_MiniBooNE/may06_om_mul/";
	std::vector<TString> filelist = {
		"may06_om_reweighted_mul"};
//	file_order = {"","_1","_2"};
...
//		   std::cout<<"CHECK "<<breaker<<std::endl;
//		   if(breaker>4) break;
...
//			   gSystem->RedirectOutput(0,0);
			   ...
			   std::cout<<"\n"<<Onefile->GetName()<<" "<<temp_file.GetEntries()<<std::endl;
			   if(current_file_name.Contains("_1.r") || current_file_name.Contains("_2.r")){ 
				   entry_marks.back() += temp_file.GetEntries();
				   std::cout<<"\n^^^^ Update entries mark: "<<entry_marks.back()<<std::endl;
			   }else{
				   std::cout<<"---> Mark Entries "<<temp_file.GetEntries()<<std::endl;
...
//		   std::cout<<"\nTotal number: "<<tree->GetEntries()<<std::endl;
		   ...
		   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(dir_path);

		   if (!f || !f->IsOpen()) {
			   f = new TFile(dir_path);
		   }
