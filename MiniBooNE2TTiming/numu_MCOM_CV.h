...
// Wed Sep 23 00:44:31 2020 by ROOT version 6.12/04
// from TTree MiniBooNE/Created in may06_om_reweighted.root
// found on file: /scratch/klin/SystematicFiles/numu/TTree_MiniBooNE/may06_om_reweighted.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxTHistory = 285;
   static constexpr Int_t kMaxTHistory_algo_name = 285;
   static constexpr Int_t kMaxTHistory_algo_inst = 285;
   static constexpr Int_t kMaxTHistory_chunk_name = 285;
   static constexpr Int_t kMaxTHistory_ext_name = 285;
   static constexpr Int_t kMaxTHistory_version = 285;
   static constexpr Int_t kMaxTHistory_node = 285;
   static constexpr Int_t kMaxTHistory_database = 285;
   static constexpr Int_t kMaxTHistory_inst_num = 285;
   static constexpr Int_t kMaxTHistory_timestamp = 285;
   static constexpr Int_t kMaxTHistory_rcpid = 285;
   static constexpr Int_t kMaxTHistory_chunkid = 285;
   static constexpr Int_t kMaxTHistory_parents = 285;
   static constexpr Int_t kMaxTHistory_tags = 285;
   ...
   static constexpr Int_t kMaxTParticleIDChunk = 142;
   static constexpr Int_t kMaxTParticleIDChunk_chunk_id = 142;
   static constexpr Int_t kMaxTParticleIDChunk_name = 142;
   static constexpr Int_t kMaxTBacklightExcessLiteChunk = 3;
   static constexpr Int_t kMaxTBacklightExcessLiteChunk_chunk_id = 3;
   static constexpr Int_t kMaxTBacklightExcessLiteChunk_name = 3;
