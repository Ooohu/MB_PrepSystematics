...
// Thu Sep  3 09:53:21 2020 by ROOT version 6.12/04
// from TTree MiniBooNE/Created in ./may06_om_mul/may06_om_reweighted_mul031.root
// found on file: /scratch/condor-tmp/klin/systematics/prepareSystematicsFile/staged_Sep3_2020/may06_om_mul/may06_om_reweighted_mul031.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxTHistory = 147;
   static constexpr Int_t kMaxTHistory_algo_name = 147;
   static constexpr Int_t kMaxTHistory_algo_inst = 147;
   static constexpr Int_t kMaxTHistory_chunk_name = 147;
   static constexpr Int_t kMaxTHistory_ext_name = 147;
   static constexpr Int_t kMaxTHistory_version = 147;
   static constexpr Int_t kMaxTHistory_node = 147;
   static constexpr Int_t kMaxTHistory_database = 147;
   static constexpr Int_t kMaxTHistory_inst_num = 147;
   static constexpr Int_t kMaxTHistory_timestamp = 147;
   static constexpr Int_t kMaxTHistory_rcpid = 147;
   static constexpr Int_t kMaxTHistory_chunkid = 147;
   static constexpr Int_t kMaxTHistory_parents = 147;
   static constexpr Int_t kMaxTHistory_tags = 147;
