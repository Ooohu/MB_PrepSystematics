...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxTHistory = 80;
   static constexpr Int_t kMaxTHistory_algo_name = 80;
   static constexpr Int_t kMaxTHistory_algo_inst = 80;
   static constexpr Int_t kMaxTHistory_chunk_name = 80;
   static constexpr Int_t kMaxTHistory_ext_name = 80;
   static constexpr Int_t kMaxTHistory_version = 80;
   static constexpr Int_t kMaxTHistory_node = 80;
   static constexpr Int_t kMaxTHistory_database = 80;
   static constexpr Int_t kMaxTHistory_inst_num = 80;
   static constexpr Int_t kMaxTHistory_timestamp = 80;
   static constexpr Int_t kMaxTHistory_rcpid = 80;
   static constexpr Int_t kMaxTHistory_chunkid = 80;
   static constexpr Int_t kMaxTHistory_parents = 80;
   static constexpr Int_t kMaxTHistory_tags = 80;
   ...
   static constexpr Int_t kMaxTMulMatWeightsChunk = 4;
   static constexpr Int_t kMaxTMulMatWeightsChunk_chunk_id = 4;
   static constexpr Int_t kMaxTMulMatWeightsChunk_name = 4;
...
newroot::newroot(TTree *tree) : fChain(0) 
{
	...
	std::vector<TString> filelist = {
		"may07_weighted_mul",
		"may07_weighted_mul_Pi0Yield_add",
		"may07disc_weighted",//2
		"may07qtcorr_weighted",//3
		"may06_om_reweighted"};
