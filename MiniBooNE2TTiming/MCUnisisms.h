...
// Thu Sep  3 09:18:44 2020 by ROOT version 6.12/04
// from TTree MiniBooNE/Created in ./may07Disc_weighted.root
// found on file: /scratch/condor-tmp/klin/systematics/prepareSystematicFiles/outputroots/may07Disc_weighted.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxTHistory = 69;
   static constexpr Int_t kMaxTHistory_algo_name = 69;
   static constexpr Int_t kMaxTHistory_algo_inst = 69;
   static constexpr Int_t kMaxTHistory_chunk_name = 69;
   static constexpr Int_t kMaxTHistory_ext_name = 69;
   static constexpr Int_t kMaxTHistory_version = 69;
   static constexpr Int_t kMaxTHistory_node = 69;
   static constexpr Int_t kMaxTHistory_database = 69;
   static constexpr Int_t kMaxTHistory_inst_num = 69;
   static constexpr Int_t kMaxTHistory_timestamp = 69;
   static constexpr Int_t kMaxTHistory_rcpid = 69;
   static constexpr Int_t kMaxTHistory_chunkid = 69;
   static constexpr Int_t kMaxTHistory_parents = 69;
   static constexpr Int_t kMaxTHistory_tags = 69;
   ...
   static constexpr Int_t kMaxTMulMatWeightsChunk = 3;
   static constexpr Int_t kMaxTMulMatWeightsChunk_chunk_id = 3;
   static constexpr Int_t kMaxTMulMatWeightsChunk_name = 3;
...
// used to generate this class and read the Tree.
   std::vector<TString> filelist = {"/scratch/klin/SystematicFiles/nue/TTree_MiniBooNE/may07disc_weighted.root",
	   "/scratch/klin/SystematicFiles/nue/TTree_MiniBooNE/may07qtcorr_weighted.root"};

   TString filename = filelist[1];
   if (tree == 0) {
